...
VALUES 
    ...
    (-500, 'Test Tour 1 - Draft with Duration', 'Draft tour with initial duration', 1, 'test,nature,hiking', 0, 0, -1, NULL, NULL),
    (-501, 'Test Tour 2 - Draft without Duration', 'Draft tour for publish failure test', 2, 'test,mountain', 0, 50, -1, NULL, NULL);